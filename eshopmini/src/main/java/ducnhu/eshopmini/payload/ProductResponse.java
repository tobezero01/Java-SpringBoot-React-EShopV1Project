...
public class ProductResponse {
    ...
    public String toString() {
        return "ProductResponse(content=" + this.getContent() + ", pageNumber=" + this.getPageNumber() + ", pageSize=" + this.getPageSize() + ", totalElements=" + this.getTotalElements() + ", totalPages=" + this.getTotalPages() + ", lastPage=" + this.isLastPage() + ")";
    }
}
